# GitHub Management via Terraform: ipld

This repository is responsible for managing GitHub configuration of `ipld` organisation as code with Terraform. It was created from [github-mgmt-template](https://github.com/protocol/github-mgmt-template) and it will receive updates from that repository.
